  $(document).ready(function(){
    ...
    if (loggedin==1) {
        ...
        // set the href propery to0 point to login.html if user clicks on it
    ...
    /* localstroa01ge is a javascript object that allows us to store key/value pairs 
    https://javascript.info/localstorage */
    if (localStorage.getItem('userdetails') === null) {  
        // if userdetails is null, that means it has not been loaded before. we not initialise userdetails object
        var userDetails = {firstName:"Joe", lastName:"Bloggs", dob:"1994-05-22",address1:"Sligo Town", address2:"Strandhill", address3:"Co. Sligo"};
    ...
    $('form[name="login"]' ).submit(function( event ) {
        ...
        if (email=="joebloggs@mail.com" && password=="password")  {   
